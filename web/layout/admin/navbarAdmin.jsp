    ...
    <body>
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark vh-100" style="width: 280px; position: fixed">
            ...
            <ul class="nav nav-pills flex-column mb-auto fs-5 text">
                <li class="nav-item ">
                    <a href="dashboardAdmin" class="nav-link text-white d-flex align-items-center" aria-current="page">
                ...
                <li>
                 ...
                 <hr>
                <li>
                    <a href="historyAdmin" class="nav-link text-white">
                ...
                <hr>
                <li>
                    <a href="bookingAdmin" class="nav-link text-white">
