<%-- 
    Document   : footer
    Created on : Jun 17, 2022, 1:14:25 PM
    Author     : HHPC
--%>
        ...
        <footer class="w-100  border-top mt-auto">
            <div class="container d-flex flex-wrap justify-content-between align-items-center " style="padding: 12px">
                ...
                <ul class="nav col-md-4 justify-content-end flex-column align-items-center">
                    <p style="color: #fff;" >The website is inspired by</p>
                    <div class="d-flex">
                        <li class="nav-item link-inspried"><a href="https://4rau.vn/" target="_blank" class=" px-2 ">4rau.vn</a></li>
                        <span style="color:#fff">|</span>
                        <li class="nav-item link-inspried"><a href="https://classic.vn/" target="_blank" class=" px-2  ">classic.vn</a></li>
                    </div>
